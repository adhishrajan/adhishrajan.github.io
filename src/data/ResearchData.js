...
export const ResearchList = [
    {
      img: "/fsil.png",
      title: "Fintech Lab @ Georgia Tech",
      description: "My research is mainly involved in leveraging NLP techniques to innovate existing financial systems. Most recently, our team is developing and deploying an end-to-end consumer complaint analysis system, including data annotation, LLM training, and consumer satisfaction model, for potential integration into a trading strategy.",
      links: "https://www.vip.gatech.edu/teams/vxu"
    },
  ];
